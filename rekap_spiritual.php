            ...
            <div id="page-inner">
                <!--<div class="row">-->
                   <!--<div class="panel-heading">-->
                    <div class="col-lg-12">
                    <h2>Rekap Nilai Sikap Spiritual Siswa</h2>   
                                  ...
                                  <?php
                                    if (isset($_POST['cari'])){
                                      ...
                                      $sql_nilai = mysqli_query($conn,"SELECT a.*,b.nama,d.thn,e.smstr,f.kls FROM nilai_sos_sp a 
                                       ...
                                       $sql_spirit = mysqli_query($conn,"select * from sikap where sikap='spiritual'");
									   $spirit = mysqli_fetch_array($sql_spirit);
									   $no=0;
                                      while ($nilai = mysqli_fetch_array($sql_nilai)){
                                        $no++;
										if (($nilai['nil_sprtsb']=='1') and ($nilai['nil_sprtpb']=='0'))
											$deskripsi = "sangat baik dalam ".$spirit['ket_1sp'].", ".$spirit['ket_2sp'].", ".$spirit['ket_3sp']." serta ".$spirit['ket_4sp'];
										else if (($nilai['nil_sprtsb']=='1') and ($nilai['nil_sprtpb']=='1'))
											$deskripsi = "sangat baik dalam ".$spirit['ket_1sp'].", ".$spirit['ket_2sp'].", ".$spirit['ket_3sp']." serta ".$spirit['ket_4sp'].
														", namun masih perlu bimbingan dalam sikap tersebut.";
										else if (($nilai['nil_sprtsb']=='0') and ($nilai['nil_sprtpb']=='1'))
											$deskripsi = "kurang dalam ".$spirit['ket_1sp'].", ".$spirit['ket_2sp'].", ".$spirit['ket_3sp']." serta ".$spirit['ket_4sp'].
